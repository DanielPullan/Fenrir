...
// Configuration file for Krypton \\
	...
	//Site Configuration
	$_CONFIG['site']['url'] = 'http://localhost/fenrir'; //Server URL example.com (DOES NOT END WITH /)
	...
	$_CONFIG['site']['twapi'] = 'https://twitter.com/poole_high'; //Your website Twitter API number
?>
